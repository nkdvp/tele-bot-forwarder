...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "pair_form.mask_add_first": "+ Add first mask",
        "pair_form.mask_user_id_hint": "Paste the Telegram user ID. To find it: forward their message to @userinfobot",
    ...
    "vi": {
        ...
        "pair_form.mask_add_first": "+ Thêm ẩn danh đầu tiên",
        "pair_form.mask_user_id_hint": "Dán Telegram User ID vào đây. Để tìm: chuyển tiếp tin nhắn của họ đến @userinfobot",
